...
Some tuneups taken from [jooray](https://github.com/jooray/dotfiles). 
...
```bash
git clone https://github.com/freezy-sk/dotfiles.git && cd dotfiles && source bootstrap.sh
```
...
```bash
cd; curl -#L https://github.com/freezy-sk/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,.osx,LICENSE-MIT.txt}
```
